...
inflation = pd.read_csv('data/inflation/weeklyInflationST.csv')
NCAVValue = pd.read_csv('printoutST.csv', usecols=["Total"])
benchValue = pd.read_csv('benchmarkST.csv', usecols=["Invested"])
